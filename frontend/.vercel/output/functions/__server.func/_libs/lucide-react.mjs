...
const BookmarkCheck = createLucideIcon("bookmark-check", __iconNode$N);
const __iconNode$M = [
  [
    "path",
    {
...
const Film = createLucideIcon("film", __iconNode$v);
const __iconNode$u = [
  [
    "path",
    {
...
const Gauge = createLucideIcon("gauge", __iconNode$t);
const __iconNode$s = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const MessageSquarePlus = createLucideIcon("message-square-plus", __iconNode$o);
const __iconNode$n = [
