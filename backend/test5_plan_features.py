...
# Test /api/admin/plan-features with token
plans_url = "http://localhost:8000/api/admin/plan-features"
req = urllib.request.Request(plans_url, headers={'Authorization': f'Bearer {token}'})
with urllib.request.urlopen(req) as response:
